...
function numberOfCharacters(string) {
   ...
   return string.split('')
      .sort()
      .reduce(function (objeto, letra) {
         objeto[letra] = (objeto[letra] || 0) + 1; // Esta expresión asigna o incrementa el valor de la letra en el objeto, usando el operador lógico || que devuelve el primer valor verdadero o el último falso.
         return objeto;
      }, {});
}
...
function capicua(numero) {
   ...
   if (numeroStr === reverse(numeroStr)) return "Es capicua";
